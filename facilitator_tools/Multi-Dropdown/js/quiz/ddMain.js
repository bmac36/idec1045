...
DragAndDropApp.buildAnswerSlots = function() {
    ...
    for(var c = 0; c < DragAndDropApp.AnsSlotData.length; c++)
    {
        ...
        if (DragAndDropApp.AnsSlotData[c].src != "none"){
            ...
            style = "border: " + slotColor + " 1px dashed; margin-left:5%; margin-right:5%; margin-top:-10px; background-image: url(" + slotBackground + ");";
        }
        else {
            DragAndDropApp.savedBackgrounds[c] = DragAndDropApp.AnsSlotData[c].src;
            style = "border: " + slotColor + " 1px dashed; margin-left:5%; margin-right:5%; margin-top:-10px;";
        }
